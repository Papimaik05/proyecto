...
(27, 'Genial', 'admin', 26, 'Estaba dudando si ir con mi abuela de 60 anios, ahora tengo claro que es una idea nefasta, muchas gracias', '2023-05-03', 0),
...
(3, './img/foto-lluvia-peces.jpg', 'El pasado 23 de abril, se dio un suceso que nunca se había dado hasta ahora en la historia de la humanidad, el centro de Madrid se vio envuelto en una lluvia de peces payaso Nemo entre ellos.', '2023-05-03', 'Lluvia de peces en Madrid'),
(4, './img/aqua.jpg', 'En una de nuestras últimas experiencias se ha reportado la presencia de un ser desconocido, algunas personas dicen que se parecía a Aquaman, otras dicen que se parecía a Jason Momoa, de momento no esta confirmado quien es pero lo descubriremos.', '2023-04-20', 'Aquaman ha sido visto'),
(5, './img/esponja.jpg', 'Hace menos de un mes tuvimos una visita inesperada, nos visito nada más y nada menos que Bob Esponja, acompaniado de todos sus amigos de fondo de Bikini, Bob Esponja y sus amigos pudieron disfrutar de una pesca con el gran Iniaki, se lo pasaron de lo grande y repetirán.', '2023-04-19', 'Bob Esponja ha acudido a una de nuestras experiencias'),
(6, './img/bikini-bottom.jpeg', 'Estamos trabajando de forma muy ardua en los últimos meses para poder daros nuevas experiencias, estamos trabajando en diferentes sectores de los que pronto tendréis noticias, fondo de bikini no esta tan lejos como pensamos.', '2023-05-04', 'Futuro de las experiencias.'),
(7, './img/hielo.jpeg', 'Según unos últimos estudios científicos, el color del hielo de la Antártida esta cambiando de color ahora esta empezando a ser rojo, según este estudio en menos de 10 anios todo el hielo de la Antártida será rojo, esto no supondrá ningún cambio ni para bien ni para mal lo cual es bastante bueno porque no afectara a la fauna.', '2023-04-29', 'El hielo de la Antártida esta cambiando de color.'),
(8, './img/cargador.jpg', 'Nuestros mejores científicos están trabajando de forma incansable en conseguir crear unos cargadores para móvil submarinos, en cuanto estos cargadores estén listos, serán puestos a la venta y se proporcionarán en cada una de nuestras experiencias para que no os quedéis sin batería nunca y podáis grabar toda la experiencia.', '2023-05-03', 'Cargadores de móvil submarinos'),
(9, './img/cochee.jpg', 'En las últimas semanas, unos estudiantes han conseguido crear un coche que funciona bajo el mar, este coche va por el fondo marino sin ningún tipo de problema, cualquier persona podría conducirlo sin ningún tipo de problema.', '2023-05-02', 'Estudiantes crean un coche submarino');
...
('Cania Anguila', 4, 'Con esta cania podrás pescar cualquier animal bajo el mar.', 8, 79.99, './img/cana.jpg'),
...
('Baniador Sportacus Hombre', 7, 'Baniador de pinguinos masculino para sumergirte y ser uno más de ellos.', 33, 9.99, './img/banador.jpg'),
...
('Baniador Sportacus Mujer', 9, 'Baniador de pinguinos femenino para sumergirte y ser uno más de ellos.', 45, 14, './img/banadorm.jpg'),
...
('Nevera portátil', 13, 'Con su disenio aislado térmicamente y la ayuda de algunos cubitos de hielo, esta nevera portátil es la companiera perfecta para mantener tus bebidas y alimentos frescos en cualquier lugar y en cualquier momento. ', 7, 30, './img/nevera.jpg'),
...
('Flotador ', 16, 'Este flotador para ninios es la herramienta perfecta para que los más pequenios de la casa aprendan a nadar y se diviertan en la playa. Con su disenio ergonómico y seguro, este flotador está hecho con materiales de alta calidad y resistentes al agua, para asegurar la durabilidad del producto.', 18, 10, './img/flotador.jpg'),
('Kit Buceo Ninios', 17, '¿Estás buscando una aventura emocionante en el agua con tus hijos? ¡Nuestro kit de buceo para ninios es perfecto para ti! Diseniado para los pequenios exploradores submarinos, nuestro kit incluye todo lo que necesitan para sumergirse en el mundo del buceo de manera segura y divertida.', 23, 15, './img/kitBuceo.jpg'),
('Bronceador', 18, 'Nuestro bronceador te ayudará a obtener ese tono dorado que tanto deseas mientras disfrutas de un relajante paseo en barca. Además, su fórmula especial te protegerá de los rayos UV daniinos del sol, manteniendo tu piel sana y hermosa', 12, 14, './img/bronceador.jpg'),
...
('Escarpines', 20, 'Los escarpines son el complemento perfecto para tus aventuras acuáticas. Estos zapatos de neopreno son ligeros y cómodos, y están diseniados para proteger tus pies en el agua y en la orilla. Con su suela antideslizante, podrás caminar con confianza sobre rocas y superficies resbaladizas, mientras que su ajuste ceniido te garantizará un gran ajuste y flexibilidad para poder moverte libremente. ', 15, 25, './img/escarpines.jpg'),
('Chaleco Salvavidas', 21, 'Un chaleco salvavidas es el mejor amigo de cualquier persona que se divierte en el agua. Es como un abrazo cálido y protector que te da seguridad y tranquilidad, sabiendo que te mantendrá a flote en caso de emergencia. Con un disenio cómodo y ajustable, puedes sentirte libre de moverte con facilidad y disfrutar al máximo de tus actividades acuáticas favoritas, sabiendo que siempre estarás seguro y protegido.', 17, 38, './img/chaleco.jpg'),
...
('Casco Surf', 23, '¡Protege tu cabeza mientras surfeas con estilo con nuestro casco de surf! Este casco ha sido diseniado pensando en tu seguridad y comodidad, lo que significa que puedes concentrarte en montar las mejores olas. Con una carcasa resistente y un acolchado suave en el interior, este casco te mantendrá protegido de cualquier impacto mientras te deslizas sobre el agua. Además, su disenio ligero y ventilado te mantendrá fresco incluso en los días más calurosos. ¡Prepárate para montar olas con confianza con nuestro casco de surf!', 26, 35, './img/casco.jpg'),
('Piragua', 24, '¡La aventura está a solo unos remos de distancia con nuestra piragua! Disfruta de la naturaleza y explora los lagos y ríos cercanos en una de nuestras piraguas de alta calidad. Ya sea que seas un novato o un experto, nuestras piraguas ofrecen una experiencia divertida y emocionante en el agua. Con su disenio resistente y cómodo, podrás remar sin preocupaciones y disfrutar del paisaje mientras te mantienes activo y en forma. ', 11, 150, './img/piragua.jpg');
